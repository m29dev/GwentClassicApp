const { deckMonsters } = require("./deckMonsters")
...
const app = () => {
    cards.map(item => {
        ...
        if (item.deck === "scoiatael") {
            scoiatael.push(item)
        }

        if (item.deck === "monsters") {
            monsters.push(item)
        }

        if (item.deck === "nilfgaard") {
            nilfgaard.push(item)
        }

        if (item.deck === "weather") {
            weather.push(item)
        }

        if (item.deck === "special") {
            special.push(item)
        }

        if (item.deck === "neutral") {
            neutral.push(item)
        }
    })
